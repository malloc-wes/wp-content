...
<html lang="en"> 
<head>
    <title>JazzyTunes Template</title>
    <!-- Meta -->
    <meta charset="utf-8">
	...
	<!-- Theme CSS/FontAwesome/Bootsrap -->
   <?php
   wp_head();
   ?>
...
<body>
    ...
    <header class="header text-center">	    
	    <a class="site-title pt-lg-4 mb-0" href="index.html">JazzyTune.dev</a>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-sm-center text-md-left">
					...
					<li class="nav-item">
					    <a class="nav-link" href="post.html"><i class="fas fa-file-alt fa-fw mr-2"></i>Jazz Forum Club</a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="page.html"><i class="fas fa-file-image fa-fw mr-2"></i>Summer Concerts</a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="archive.html"><i class="fas fa-archive fa-fw mr-2"></i>More</a>
					</li>
					<li class="nav-item">
    ...
    <div class="main-wrapper">
	    <header class="page-title theme-bg-light text-center gradient py-5">
			<h1 class="heading">Jazzy Tunes (Version 1.0)</h1>
		</header>
	    ...
	    <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <p class="copyright"><a href="https://youtube.com/FollowAndrew">Footer</a></p>
